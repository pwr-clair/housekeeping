...
- **템플릿 제목은 비워도 된다** (방문고지 등 — OTA 채팅에 제목 헤더가 안 뜨게 하는 운영 방식). 발송 조건은 본문(bodyKo/bodyEn/body) 존재뿐이며, 자동발송에 "제목 필수" 가드를 되살리지 말 것 — 그 가드가 방문고지 자동발송을 매일 조용히 0건으로 만들던 실사고 원인 (2026-08-02).
